...
public class ExpensesActivity extends AppCompatActivity implements ExpensesAdapter.ExpensesAdapterEventListener {
    ...
    public void onExpenseLongClicked(long movementsId) {
        ...
        builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Movement movements = Database.getInstance(ExpensesActivity.this).getmovementsDAO().getById(movementsId);
    ...
    public void updateIncomeList(){
        List<Movement> movementsList = Database.getInstance(this).getmovementsDAO().getExpense(this.userId);
