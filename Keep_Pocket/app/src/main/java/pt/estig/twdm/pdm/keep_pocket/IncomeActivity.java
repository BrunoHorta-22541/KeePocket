...
public class IncomeActivity extends AppCompatActivity implements IncomeAdapter.IncomeAdapterEventListener {
    ...
    public void updateIncomeList(){
        List<Movement> movementsList = Database.getInstance(this).getmovementsDAO().getIncome(this.userId);
    ...
    public void onIncomeLongClicked(long movementsId) {
        ...
        builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Movement movements = Database.getInstance(IncomeActivity.this).getmovementsDAO().getById(movementsId);
